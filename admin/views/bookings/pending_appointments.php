...
<?php endif; ?>
   ...
   <div class="card ">
            ...
            <div class="card-body table-responsive-sm">
                ...
                <?php
                $stmt = $conn->prepare(
                    'SELECT * FROM `bookings` WHERE `status`="pending" ORDER BY `id` DESC'
                );
                $stmt->execute();
                $cnt = 1;
                ...
                while ($row = mysqli_fetch_array($result)) { 
                 ...
                 $ustatus ="<a href='javascript:;' onClick='pickRow(" . json_encode($row) .")' 
                                data-toggle='modal'  class='btn btn-primary btn-sm' id='viewbtn' style='width:100%'>view
                                </a>";
                echo "<tr>
                                <td>".$cnt."</td>
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="" id="seenbtn" class="btn btn-success">Seen
                            </a>
                            </div>
  ...
  <script>
    ...
    function pickRow(res){
        ...
        $('#seenbtn').prop("href", `pending_appointments.php?bkid=${res.id}`);
