...
<?php include_once './views/header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php endif; ?>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info" id="myform">
              ...
              <form action="add_article.php?id=<?php echo $row[
                  'id'
              ]; ?>" role="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        <label for="usr">Title</label>
                        <textarea class="form-control" rows="1"  id="usr" name="article-title" required><?php echo $row[
                            'title'
                            ]; ?></textarea>
      ...
      <textarea class="form-control" rows="5"  id="article-body" name="article-body"><?php echo $row[
          'description'
      ]; ?></textarea>
    </div>
                ...
                <div class="form-group">
                    <img src=<?php echo $row['featured_image']; ?> height="150" width="170">
                </div>
                  <div class="form-group">
                    <label for="featured-article-image">Change featured image (optional)</label>
